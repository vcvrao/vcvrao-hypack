...
const char * matMatMultKernelPathGMDP = "MatMatMultGlobalMemDP_kernel.cl";
...
********************************************************************/
void setExeEnvMatMatMultGMDP(cl_context *context, cl_uint *numDevices, cl_device_id **devices, cl_program *program,cl_uint *num_platforms,cl_platform_id *selectedPlatform,cl_int *err)
{
	...
	char* programSource = readKernelSource(matMatMultKernelPathGMDP);
...
*************************************************************/
void    matrixMatrixMultGMDP (cl_uint numDevices,cl_device_id *devices, cl_program program,cl_context context,double * h_MatA, double *h_MatB, double *h_Output,int height,int width)
{
	...
	/* calculate gflops*/
	 ...
	 print_on_screen("Matrix Matrix Multiplication-Global Memory Double Precision",executionTimeInSeconds,height,gflops,1);
...
******************************************************************/
int matMatMultCheckResultGMDP (double *h_MatA, double *h_MatB,double *output, int rows, int cols)
{
...
int main(int argc,char *argv[])
{
	...
	setExeEnvMatMatMultGMDP( &context , &numDevices, &devices, &program,&num_platforms,&selectedPlatform,&err );

	//function to calculate Matrix Matrix Multiplication
	matrixMatrixMultGMDP(numDevices, devices, program, context, h_MatA,h_MatB, h_Output,height,width);


	/*  check opencl results with cpu results*/

	  matMatMultCheckResultGMDP( h_MatA,h_MatB,h_Output, height , width );
