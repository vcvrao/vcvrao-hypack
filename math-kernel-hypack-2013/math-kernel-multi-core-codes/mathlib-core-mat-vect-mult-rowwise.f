...
c
c Example 1.2           : mathlib-core-mat-vect-mult-rowwise.f
c
c Objective 	        : Write a program for Matrix-Vector Multiplication. The 
c                         Matrix entries should be accessed in Row-wise fashion. 
c                         Explain the reasons for performance.
c
...
c                         rowwise fashion and performance in MFLOPS.
c
...
c     fashion
      ...
      do 50, i=1,MatRowSize
      do 40, j=1,MatColSize
