...
*
  ...
  Objective         : To gather non-uniform data from all the processes
                      Gather data into specified locations from all
                      tasks in a Group using MPI Collective comm. 
                      library gatherv call.
  ...
  Input             : Data from files (gdata0,gdata1,gdata2,gdata3,gdata4,
                      gdata5,gdata6,gdata7) is available on respective
                      processes.  Array size and array of integer values 

  Output              : All the values on Process with Rank 0 
