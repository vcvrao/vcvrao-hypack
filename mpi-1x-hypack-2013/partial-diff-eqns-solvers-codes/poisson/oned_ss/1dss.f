...
c   a 1-d array when given a number of processors.  It may be used 
c   in "direct" product decomposition.  The values returned assume 
c   a "global" domain in [1:n]
c
...
c
c	THIS SUBROUTINE USES SYNCHRONISE SEND AND RECV MPI 
c	LIBRARY CALLS
