...
c
      ...
      integer nx, ny
      integer myid, Root, numprocs, ierr
...
103	format(4x,'Number of cells exceeds the dimension of the arrays')
         go to 30
      endif
...
c
c     ....Initialize the RHS(f) and the initial guess solution (a)
c
...
105        format(4x,'Converged after ', i8, 'Iterations and the time 
...
c      ---------------------------------------------------------------
c
c...........THIS PROGRAM USES SEND AND RECV MPI LIBRARY CALLS.............
