...
*******************************************************************
   ...
   Example 4.4	: upper-traingular-portion-ddtype.c

   Objective    : To build derived datatype in which process with rank 0 
                  sends one row entries of a two dimensional real array, 
                  which are contiguous entries of two dimensional real array 
                  to the process with rank 1. 

   Input        : The input file for Two dimansioanl real array 

   Output       : Process with Rank 1 prints the elements of the Upper traingular 
                  matrix entries in a row-wise 
