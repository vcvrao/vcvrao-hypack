...
c
c  Example 5.9	       : mm_mult_cartesian.f
c
...
c*********************************************************************
	 ...
	 integer Numprocs, MyRank, MyGlobalRank, root_p
  	...
  	real Matrix_A(ROW_SIZE_A,COL_SIZE_A),
     $       Matrix_B(ROW_SIZE_B,COL_SIZE_B),
     $       Matrix_C(ROW_SIZE_A,COL_SIZE_B)

  	real MatA_array(TOTAL_SIZE_A), MatB_array(TOTAL_SIZE_B), 
     $ 	     MatC_array(TOTAL_SIZE_C)
  	real A_Bloc_Matrix(TOTAL_SIZE_A), 
     $       B_Bloc_Matrix(TOTAL_SIZE_B), 
     $ 	     C_Bloc_Matrix(TOTAL_SIZE_C)

  	real LocalMatrix_A(TOTAL_SIZE_A)
  	real LocalMatrix_B(TOTAL_SIZE_B)
  	real RowBlock_A(TOTAL_SIZE_A), ColBlock_B(TOTAL_SIZE_B)
