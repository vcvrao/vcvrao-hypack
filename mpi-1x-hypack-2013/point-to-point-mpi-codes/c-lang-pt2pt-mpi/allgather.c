...
*******************************************************************
   ...
   Example 9		: allgather.c


   Objective           : To gather data from all the processes  
   ...
   Input               : Data from files 
                         (gdata0,gdata1,gdata2,gdata3,gdata4, 
                         gdata5,gdata6,gdata7) is available on 
                         each process.

   Output              : Gathered data is printed on each  processes.
