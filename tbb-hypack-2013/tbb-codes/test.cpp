/***************************************************************************
 ...
 Objective          : Advance example program , to do parallel multiple reduction operation at same 
                      time and finding min and max value with in an array.
 Demonstrates       : parallel_for().

 Input              : Array of integer 

 Output             : result of +reduction, *reduction and Max and Min element within 
                      input array     
