...
{  
    ...
    for (int i=0; i<num_of_producers; i++ )
    {
			...
			assign_num = ndiv;
                Producer prod[i];
                printf("\n.....................................................................................\n");
                printf("\n Producer %d is producing input for mat-mat multiplication ....\n",i);
                parallel_for (tbb::blocked_range<size_t> (0, assign_num), prod[i]); //calling operator function for producer
                printf("\n.....................................................................................\n");
    }                                                                               
...
void consumer(int num_items,int num_of_consumers)             // consumer function definition 
{
		...
		if(i==(num_of_consumers - 1))
               ...
               Consumer cons[i];
               printf("\n.....................................................................................\n");
               printf("\n Consumer %d is performing mat-mat multiplication .....\n",i );
