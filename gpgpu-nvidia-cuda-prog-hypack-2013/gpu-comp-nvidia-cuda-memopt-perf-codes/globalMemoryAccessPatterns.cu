...
// there are six patterns that have been quoted in programming guide 2.3.1 
...
//////////////////////////////////////////////////////////////////////////////////////////////
//
// the access pattern where successive threads are acceessing the successive 
// memory locations in the Global memory  and the array is aligned at (128)
...
////////////////////////////////////////////////////////////////////////////////////////////////
//
// the access pattern where successive threads are accessing the successive memory 
// locations in the Global memory  but the starting address is misaligned
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// the access pattern where successive threads are not accessing the successive 
// memory locations in the Global memory the starting address is aligned
...
__global__ void nonCoalescedGMAccessNonSeq(float* dest,float* src,long size)
{
	...
	//in each half warp the third thread accesses the location which would have 
        //been accessed by the fourth thread in coalesced access
