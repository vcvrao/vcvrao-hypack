/*****************************************************************************
  ...
  Example     : cuda-PI-computation.cu
 
  Objective   : Write a CUDA Program to calculate value of PI using numerical integration method..
...
// This is code for Pi calculation....
#include<stdio.h>
#include<cuda.h>
#define BLOCKSIZE 16
#define SIZE 1024
