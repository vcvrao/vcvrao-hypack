/*****************************************************************************
  ...
  Objective   : Write CUDA code sparse_sp_matrix vector multiplication 
                using Compressed Sparse Row(CSR) format
  Input       : <no. of rows> <sparsity in the range of 0 to 1>

  Output      :time taken for computation is 0.000038 seconds
...
//CUDA code sparse_sp_matrix vector multiplication using Compressed Sparse Row(CSR) format
