...
/*****************************************************************************
		        ...
		        High Performance Computing 
                   Frontier Technologies Exploration GRoup 
                            (VCV.Rao)

 Test Prog.         : OpenMP based Program for Matrix into Matrix 
                      Multiplication 

 Example            : matrix-matrix-multply-par_mic-openmp_c-lang.c
 ...
 Output             : Each thread computes the partial contribution of matrix matrix 
                      multiplication  based on openMP and MIC 
                                                                       
 Created            : (VCV.Rao, Krishan, Samrit & Sonia) 
                      HPC-FTE Group C-DAC, Pune 
