...
/**************************************************************************
	        C-DAC Pune March 2013 
     High Performance Computing Frontier Technologies Exploration GRoup 
             Internal Release : Version V1.0 Date : April 04, 2013


 Test Prog.    : OpenMP based Program for Matrix into Matrix Multiplication 

 Example       : matrix-matrix-multiply-openmp-clang.c

 Objective     : OpenMP program to demonstrate the use of OpenMP 
 ...
 Description   : Each thread computes the partial contribution of matrix matrix 
                 multiplication  based on openMP 

 Output        : Performance Results 
                                            
 Created       : March 28, 2013 by HPC-FTE Group C-DAC, Pune 
 
 E-mail        : betatest@cdac.in  vcvrao@cdac.in                                          

 Modified      : April 04 2013 
