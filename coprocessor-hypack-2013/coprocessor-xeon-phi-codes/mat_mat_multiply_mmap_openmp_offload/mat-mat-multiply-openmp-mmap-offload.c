/***************************************************************************************************
* FILE		: mat-mat-mul-mmap-offload.c
*
* AUTHOR	: K V SRINATH
*
* INPUT		: Matrix Size
...
__attribute__((target(mic))) void doMult(double * restrict ma,double * restrict mb,double * restrict mr,int size)
{
	double sum=0.0;
	int i,j,k;
