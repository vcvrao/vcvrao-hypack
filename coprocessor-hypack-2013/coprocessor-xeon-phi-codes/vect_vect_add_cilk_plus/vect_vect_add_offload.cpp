...
*                    C-DAC Tech Workshop : hyPACK-2013
	                    October 15-18,2013
 *Example 1   	: vect_vect_add_offload.cpp
 *Objective     : Write An Cilk Plus Program For vector vector addition
 *Input         : 1)Vector size
 		  2)Number of threads
...
__declspec(target(mic)) void vector_add(double *A,double *B,double *C,int vector_size);
...
*/
		...
		double gflops1=(((((double)vector_size*vector_size*vector_size)*2))/time_elapsed);
