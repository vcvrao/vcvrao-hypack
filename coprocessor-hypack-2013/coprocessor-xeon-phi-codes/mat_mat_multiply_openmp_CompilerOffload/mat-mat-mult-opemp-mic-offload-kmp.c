...
*******************************************************************
   ...
   Example 	: matrix-matrix-multiply-opemp-mic-offload-kmp-affinity.c

  Objective     : OpenMP based Program for Matrix into Matrix Multiplication 
                : OpenMP program to demonstrate the use of OpenMP 
